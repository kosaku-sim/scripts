...
# Variables
$DiskID = "/subscriptions/950bc092-ee54-4e3e-8a4b-31c0008f3924/resourceGroups/smvdev/providers/Microsoft.Compute/disks/nexwaydev-osdisk-20220604-110051"
$VMName = "nexway-dev"
$DiskSizeGB = 190
$AzSubscription = "Microsoft Azure Sponsorship"
...
$StorageAccount = New-AzStorageAccount -ResourceGroupName $resourceGroupName -Name $storageAccountName -SkuName Premium_LRS -Location $VM.Location
